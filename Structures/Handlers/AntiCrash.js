const { botLogsWebhookID, botLogsWebhookToken } = require("../config.js");
const { EmbedBuilder, WebhookClient } = require("discord.js");
const { inspect } = require("util");
const webhook = new WebhookClient({ id: botLogsWebhookID, token: botLogsWebhookToken });
...
module.exports = (client) => {
    ...
    client.on("error", (err) => {
        ...
        embed
            ...
            .setTimestamp();
        //if (embed.data.fields.length > 23) embed.data.fields.length = 22;
